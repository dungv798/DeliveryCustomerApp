...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    Context context;
    String removeUrl = "http://192.168.1.4/Food-Delivery-App/Food-Delivery-App/food-delivery-restaurant-app/public/api/users/cart/remove";
    String addUrl =    "http://192.168.1.4/Food-Delivery-App/Food-Delivery-App/food-delivery-restaurant-app/public/api/users/cart/add";
